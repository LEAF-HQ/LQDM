...
class PostAnalyzer:
    def __init__(self, year, analysisname, t3_base_path, result_base_path, selectionstage, selectionname, systematics, backgrounds, signals, channels, histnames_in_out_per_category, limithisttag, processes_per_systematic, pdf_per_systematic, value_per_systematic):
        self.year = year
        ...
        self.finalselection_path = os.path.join(t3_base_path,     self.user, analysisname, year, selectionstage, selectionname)
