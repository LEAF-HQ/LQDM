...
# mchs_exp = [2.66] # to reasonable precision, the LQ->btau decay kinematics do not depend on DM/Psi masses
lambdas  = [1.0, 'best']
# lambdas  = ['best']
...
# EventGenerator.SubmitGridpacks(runtime=(1,00,00))
# EventGenerator.SubmitGenerationStep(generation_step='GENSIM', ncores=2, runtime=(3,00,00), mode='new')
# EventGenerator.SubmitGenerationStep(generation_step='GENSIM', ncores=8, runtime=(10,00,00), mode='resubmit')
