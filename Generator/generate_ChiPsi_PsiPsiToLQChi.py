...
processes = ['PsiPsiToLQChi']
mlqs     = [1000, 4000, 7000, 10000]
mchs_exp = [2.0, 2.33, 2.66, 3.0, 3.33]
lambdas  = [1.0]
...
for lamb in lambdas:
    for mlq in mlqs:
        ...
        for exp in mchs_exp:
            ...
            if not are_masses_allowed(mlq=prefmlq, mps=mps, mch=mch, particle_produced='Psi', decaychannels=['BTau', 'PsiChi']):
                continue
