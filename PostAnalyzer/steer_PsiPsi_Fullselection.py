...
def main():
    ...
    ScriptRunnerUL17 = ScriptRunner(year='UL17', analysisname=analysisname, input_base_path=input_base_path, result_base_path=result_base_path, selectionstage='Fullselection', selectionname='PsiPsi_03Jets2BTagLoose1LeptonCategories', plotprefix='PsiPsiToLQChi', samples=samples)



    ScriptRunnerUL17.CalculateSelectionEfficiencies(backgrounds=['VV', 'ST', 'TT', 'DYJets', 'WJets', 'QCDHad'], signals=['PsiPsiToLQChi_MLQ1000_MCH100_MPS117_L1p0', 'PsiPsiToLQChi_MLQ7030_MCH100_MPS117_L1p0', 'PsiPsiToLQChi_MLQ1000_MCH457_MPS567_L1p0', 'PsiPsiToLQChi_MLQ7030_MCH457_MPS504_L1p0', 'PsiPsiToLQChi_MLQ1000_MCH2089_MPS2221_L1p0', 'PsiPsiToLQChi_MLQ7030_MCH2089_MPS2445_L1p0'], num_and_denom=[('jets1_nominal', 'input'), ('jets2_nominal', 'input'), ('bjetloose1_nominal', 'input'), ('bjetloose2_nominal', 'input'), ('bjetmedium1_nominal', 'input'), ('bjetmedium2_nominal', 'input'), ('bjettight1_nominal', 'input'), ('bjettight2_nominal', 'input'), ('much_nominal', 'input'), ('elch_nominal', 'input'), ('noch_nominal', 'input'), ('nominal', 'input')])
