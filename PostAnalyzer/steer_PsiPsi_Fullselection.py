...
def main():
    ...
    ScriptRunnerUL17 = ScriptRunner(year='UL17', analysisname=analysisname, input_base_path=input_base_path, result_base_path=result_base_path, selectionstage='Fullselection', selectionname='PsiPsi_04_Jets2_BTagTight1_DPhiJet1Met_PtratioJet2Met', plotprefix='PsiPsiToLQChi', samples=samples)



    ScriptRunnerUL17.CalculateSelectionEfficiencies(backgrounds=['VV', 'ST', 'TT', 'DYJets', 'WJets', 'QCDHad'], signals=['PsiPsiToLQChi_MLQ1000_MCH100_MPS117_L1p0', 'PsiPsiToLQChi_MLQ7030_MCH100_MPS117_L1p0', 'PsiPsiToLQChi_MLQ1000_MCH457_MPS567_L1p0', 'PsiPsiToLQChi_MLQ7030_MCH457_MPS504_L1p0', 'PsiPsiToLQChi_MLQ1000_MCH2089_MPS2221_L1p0', 'PsiPsiToLQChi_MLQ7030_MCH2089_MPS2445_L1p0'], num_and_denom=[('input', 'input'), ('jets1_nominal', 'input'), ('jets2_nominal', 'input'), ('bjettight1_nominal', 'input'), ('dphi_j1_met_nominal', 'input'), ('ptratio_j2_met_nominal', 'input'), ('tach_nominal', 'input'), ('tach_addmu_nominal', 'input'), ('tach_addel_nominal', 'input'), ('tach_nolep_nominal', 'input'), ('much_nominal', 'input'), ('elch_nominal', 'input'), ('noch_nominal', 'input'), ('nominal', 'input')])
