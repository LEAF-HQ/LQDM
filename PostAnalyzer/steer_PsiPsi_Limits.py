...
def main():
    ...
    Analyzer17.CompareLimits(xaxistitle='M_{#psi} [GeV]', yaxistitle='#sigma(pp#rightarrow#psi#psi) [pb]', selectiontags=['_metpt_2j1bl', '_metpt_2j2bl', '_metpt_2j2bl1bm', '_metpt_2j1bm', '_metpt_2j2bm', '_metpt_2j2bm1bt', '_metpt_2j1bt', '_metpt_2j2bt'], colors=[ROOT.kRed+4, ROOT.kRed+1, ROOT.kViolet, ROOT.kAzure-2, ROOT.kOrange], signal_scaled_by=1., draw_theory=True)
